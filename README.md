...
Usage of ./filesurf:
  -cert string
        Path to specific TLS certificate file. Necessary when not using certificate generated by filesurf.
  -d string
        Base directory to serve. (default ".")
  -key string
        Path to specific TLS key file. Necessary when not using certificate generated by filesurf.
  -p string
